...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body table-border-style table-border-style">
                    <h5 class="d-inline-block mb-5">{{__('Deposits')}}</h5>
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($customer->customerDeposits($customer->id) as $deposit)
                                    <tr>
                                        <td>{{ $deposit->doc_number }}</td>
                                        <td>{{ \Auth::user()->dateFormat($deposit->txn_date) }}</td>
                                        <td>{{ \Auth::user()->priceFormat($deposit->total_amt) }}</td>
                                        <td>{{ !empty($deposit->bank) ? $deposit->bank->bank_name . ' ' . $deposit->bank->holder_name : '' }}
                                        </td>
                                        <td>{{ $deposit->private_note }}</td>
                                        <td>
                                            <div class="action-btn bg-danger ms-2">
